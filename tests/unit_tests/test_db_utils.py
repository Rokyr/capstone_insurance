...
def test_get_db_connection_failure(mocker, test_connection_parameters):
    ...
    expected_connect_args = {
        "options": f"-csearch_path={test_connection_parameters['schema']}"
    }
    ...
    mock_connect.assert_called_once_with(
        expected_connection_string, connect_args=expected_connect_args
    )
...
def test_get_db_connection_generic_exception(
    mocker, test_connection_parameters
):
